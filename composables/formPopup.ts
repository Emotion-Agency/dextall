export const useFormPopup = () => {
  const isOpen = useState('formPopup', () => false)
  const $el = ref(null)
  ...
  onMounted(() => {
    $el.value = document.querySelector('.form-popup')
    $content.value = document.querySelector('.form-popup__content')
    $grabBtn.value = document.querySelector('.form-popup__line-wrapper')
